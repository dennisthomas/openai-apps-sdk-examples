    ...
    <div className="antialiased relative w-full py-5">
      {isLoading ? (
        <div className="px-5 py-10 text-center">
          <div className="inline-flex items-center gap-2 text-gray-600 dark:text-gray-300" style={{color: 'light-dark(#4b5563, #d1d5db)'}}>
        ...
        <div className="px-5 py-10 text-center text-sm text-gray-600 dark:text-gray-300" style={{color: 'light-dark(#4b5563, #d1d5db)'}}>
...
const container = document.getElementById("devices-root");
